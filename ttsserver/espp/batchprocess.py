...
def batch_synthesis(
                ...
                parameter_control):
    """
    batch_synthesis(fs,consecutive_blocks,time_stamps,selected_inflect_block_new,emotion)
