...
class BaseVisemes:
    ...
    visemes_param = {
       'A-I':               {'duration': 2.0, 'rampin': 0.2, 'rampout': 0.8, 'magnitude': 0.99},
       'E':                 {'duration': 2.0, 'rampin': 0.2, 'rampout': 0.8, 'magnitude': 0.99},
       ...
       'M':                 {'duration': 1.0, 'rampin': 0.2, 'rampout': 0.2, 'magnitude': 0.99},
       'O':                 {'duration': 1.5, 'rampin': 0.2, 'rampout': 0.8, 'magnitude': 0.99},
       'U':                 {'duration': 1.5, 'rampin': 0.2, 'rampout': 0.8, 'magnitude': 0.99},
       'u':                 {'duration': 1.5, 'rampin': 0.2, 'rampout': 0.2, 'magnitude': 0.99},
       's':                 {'duration': 1.0, 'rampin': 0.2, 'rampout': 0.2, 'magnitude': 0.99},
       'S':                 {'duration': 1.0, 'rampin': 0.2, 'rampout': 0.2, 'magnitude': 0.99},
       'Sil':               {'duration': 3.0, 'rampin': 0.2, 'rampout': 0.2, 'magnitude': 0.99},
    }
